...
import taha.younis.pdfreaderapp.databinding.ActivityMain2Binding
import taha.younis.pdfreaderapp.viewmodel.LoaderViewModel
    ...
    private fun createLoaderRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(object : OnItemClickListener {
            override fun onItemClick(position: Int) {
                ...
                startActivity(Intent(this@MainActivity2,PdfActivity::class.java)
                    .putExtra("path",mAdapter.currentList[position].pdfFilePath.absolutePath))
            }
